...
// 获取天气（当日+未来三天）
router.get('/all', verifyToken, async (ctx) => {
  try {
...
// 代理发送，获取穿衣建议
router.post('/clothing', verifyToken, async (ctx) => {
  try {
